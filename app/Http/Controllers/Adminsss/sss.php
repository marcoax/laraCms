...
class AdminPagesController extends Controller
{
    ...
    public function store($model, AdminFormRequest $request)
    {
        ...
        return redirect(action('App\laraCms\Admin\Controller\AdminPagesController@edit', $this->models . '/' . $article->id));
    }
    ...
    public function destroy($model, $id)
    {
        ...
        return redirect(action('App\laraCms\Admin\Controller\AdminPagesController@lista', $this->models));
    }
